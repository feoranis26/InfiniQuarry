...
commands = {}
table.insert(commands, Command:new("UPDATE_HOME_POS", updateHomePosFunc, false))
...
table.insert(commands, Command:new("SET_HELPER", function() miner.helper = rednet.receive("MINER_COMMS") end, false))